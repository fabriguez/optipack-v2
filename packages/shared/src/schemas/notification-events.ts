...
export const NOTIFICATION_EVENT_REGISTRY: NotificationEventDefinition[] = [
  ...
  },
  {
    ...
    label: 'Statut de conteneur modifié',
    description: 'Déclenché à chaque changement d\'état d\'un conteneur (chargement, transit, arrivée, déchargé).',
    category: 'container',
    recipient: 'admin',
    variables: [
      { name: 'containerName', label: 'Nom du conteneur', example: 'CTN-Yaoundé-012' },
      { name: 'statusBefore', label: 'Statut précédent', example: 'LOADING' },
      { name: 'statusAfter', label: 'Nouveau statut', example: 'IN_TRANSIT' },
    ],
    attachments: [],
  },
  ...
  // ── DETTES ───────────────────────────────────────────────────────────────
  {
    kind: 'DEBT_CREATED',
    label: 'Dette créée',
    description: 'Déclenché à la création d\'une dette. Le débiteur et les administrateurs sont notifiés.',
    category: 'payment',
    recipient: 'both',
    variables: [
      { name: 'debtRef', label: 'Référence dette', example: 'DET-2024-0031' },
      { name: 'totalAmount', label: 'Montant total (XAF)', example: '15 000' },
      { name: 'motif', label: 'Motif de la dette', example: 'Colis retiré sans paiement' },
      { name: 'dueDate', label: 'Échéance', example: '15/03/2024' },
      { name: 'clientName', label: 'Nom du client', example: 'Jean Dupont' },
    ],
    attachments: [],
  },
  {
    kind: 'DEBT_DUE_SOON',
    label: 'Échéance de dette proche',
    description: 'Déclenché quand une échéance de dette arrive dans les 3 jours.',
    category: 'payment',
    recipient: 'both',
    variables: [
      { name: 'debtRef', label: 'Référence dette', example: 'DET-2024-0031' },
      { name: 'remainingAmount', label: 'Reste dû (XAF)', example: '7 500' },
      { name: 'dueDate', label: 'Échéance', example: '15/03/2024' },
      { name: 'clientName', label: 'Nom du client', example: 'Jean Dupont' },
    ],
    attachments: [],
  },
  {
    kind: 'DEBT_CANCELLED',
    label: 'Dette annulée',
    description: 'Déclenché à l\'annulation d\'une dette. Le débiteur et les administrateurs sont notifiés.',
    category: 'payment',
    recipient: 'both',
    variables: [
      { name: 'debtRef', label: 'Référence dette', example: 'DET-2024-0031' },
      { name: 'totalAmount', label: 'Montant annulé (XAF)', example: '15 000' },
      { name: 'reason', label: 'Motif de l\'annulation', example: 'Geste commercial' },
      { name: 'clientName', label: 'Nom du client', example: 'Jean Dupont' },
    ],
    attachments: [],
  },
  {
    kind: 'DEBT_STATUS_CHANGED',
    label: 'Statut de dette modifié',
    description: 'Déclenché à chaque changement d\'état d\'une dette (paiement partiel, litige, soldée).',
    category: 'payment',
    recipient: 'admin',
    variables: [
      { name: 'debtRef', label: 'Référence dette', example: 'DET-2024-0031' },
      { name: 'statusBefore', label: 'Statut précédent', example: 'ACTIVE' },
      { name: 'statusAfter', label: 'Nouveau statut', example: 'PARTIALLY_PAID' },
      { name: 'remainingAmount', label: 'Reste dû (XAF)', example: '7 500' },
    ],
    attachments: [],
  },

  // ── SUPERVISION BACKOFFICE (admin) ───────────────────────────────────────
  {
    kind: 'PAYMENT_VOIDED',
    label: 'Paiement annulé',
    description: 'Déclenché à l\'annulation d\'un paiement par un administrateur. Notifié par email aux admins.',
    category: 'admin',
    recipient: 'admin',
    variables: [
      { name: 'paymentRef', label: 'Référence paiement', example: 'PAY-20240315-0007' },
      { name: 'amount', label: 'Montant annulé (XAF)', example: '25 000' },
      { name: 'invoiceRef', label: 'Référence facture', example: 'FAC-2024-0089' },
      { name: 'reason', label: 'Motif de l\'annulation', example: 'Erreur de saisie' },
    ],
    attachments: [],
  },
  {
    kind: 'INVOICE_STATUS_CHANGED',
    label: 'Statut de facture modifié',
    description: 'Déclenché quand une facture change d\'état (impayée, partielle, réglée).',
    category: 'admin',
    recipient: 'admin',
    variables: [
      { name: 'invoiceRef', label: 'Référence facture', example: 'FAC-2024-0089' },
      { name: 'statusBefore', label: 'Statut précédent', example: 'UNPAID' },
      { name: 'statusAfter', label: 'Nouveau statut', example: 'PAID' },
    ],
    attachments: [],
  },
  {
    kind: 'INVOICE_DISCOUNT_APPLIED',
    label: 'Remise accordée sur un colis',
    description: 'Déclenché quand une remise commerciale est accordée ou retirée sur la facture d\'un colis.',
    category: 'admin',
    recipient: 'admin',
    variables: [
      { name: 'invoiceRef', label: 'Référence facture', example: 'FAC-2024-0089' },
      { name: 'trackingNumber', label: 'Numéro de suivi', example: 'OPT-2024-00142' },
      { name: 'newDiscount', label: 'Remise accordée (XAF)', example: '5 000' },
      { name: 'reason', label: 'Motif', example: 'Geste commercial' },
    ],
    attachments: [],
  },
  {
    kind: 'PARCEL_UPDATED',
    label: 'Colis modifié',
    description: 'Déclenché à la modification des informations d\'un colis (poids, destination, magasin).',
    category: 'admin',
    recipient: 'admin',
    variables: [
      { name: 'trackingNumber', label: 'Numéro de suivi', example: 'OPT-2024-00142' },
  ...
  },
  {
    ...
    description: 'Déclenché à la suppression (soft-delete) d\'un colis.',
    category: 'admin',
    recipient: 'admin',
    variables: [
      { name: 'trackingNumber', label: 'Numéro de suivi', example: 'OPT-2024-00142' },
  ...
  {
    kind: 'PARCEL_ARCHIVED',
    label: 'Colis archivés',
    description: 'Déclenché à l\'archivage d\'un ou plusieurs colis.',
    category: 'admin',
    recipient: 'admin',
    variables: [
      { name: 'count', label: 'Nombre de colis', example: '12' },
      { name: 'reason', label: 'Motif', example: 'Nettoyage de fin de mois' },
    ],
    attachments: [],
  },
  {
    kind: 'PARCEL_LOST',
    label: 'Colis perdu',
    description: 'Déclenché quand un colis est déclaré perdu. Notifié par email aux admins.',
    category: 'admin',
    recipient: 'admin',
    variables: [
      { name: 'trackingNumber', label: 'Numéro de suivi', example: 'OPT-2024-00142' },
  ...
  {
    kind: 'FUND_TRANSFER_CREATED',
    label: 'Virement initié',
    description: 'Déclenché à la création d\'un virement entre caisses (agence, siège, banque).',
    category: 'admin',
    recipient: 'admin',
    variables: [
      { name: 'reference', label: 'Référence virement', example: 'TRF-2024-0018' },
      { name: 'amount', label: 'Montant (XAF)', example: '500 000' },
    ],
    attachments: [],
  },
  {
    kind: 'FUND_TRANSFER_CONFIRMED',
    label: 'Virement confirmé',
    description: 'Déclenché à la confirmation de réception d\'un virement.',
    category: 'admin',
    recipient: 'admin',
    variables: [
      { name: 'reference', label: 'Référence virement', example: 'TRF-2024-0018' },
  ...
  {
    kind: 'FUND_TRANSFER_VOIDED',
    label: 'Virement annulé',
    description: 'Déclenché à l\'annulation d\'un virement (écriture inverse).',
    category: 'admin',
    recipient: 'admin',
    variables: [
      { name: 'reference', label: 'Référence virement', example: 'TRF-2024-0018' },
      { name: 'amount', label: 'Montant (XAF)', example: '500 000' },
      { name: 'reason', label: 'Motif de l\'annulation', example: 'Erreur de destinataire' },
    ],
    attachments: [],
  },
];
