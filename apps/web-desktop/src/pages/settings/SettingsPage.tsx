    ...
    <PageTransition>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          <Link to="/settings/loyalty" className="block">
          ...
          <Link to="/settings/branding" className="block">
            <AppCard className="hover:border-primary-300 transition">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary-50">
          ...
          {isAdmin && (
            <Link to="/settings/site" className="block">
              <AppCard className="hover:border-primary-300 transition">
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary-50">
          ...
          <Link to="/settings/debt-block" className="block">
            <AppCard className="hover:border-primary-300 transition">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary-50">
          ...
          <Link to="/settings/payment-providers" className="block">
            <AppCard className="hover:border-primary-300 transition">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary-50">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">TaraMoney, Campay, Stripe — credentials et fallback</p>
                </div>
              </div>
            </AppCard>
          </Link>
          <Link to="/settings/email" className="block">
            <AppCard className="hover:border-primary-300 transition">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary-50">
