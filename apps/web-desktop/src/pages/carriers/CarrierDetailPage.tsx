        ...
        {carrier.client && (
          <AppCard>
            ...
            <div className="flex items-center justify-between rounded-xl bg-gray-50 p-3">
              ...
              <Link to={`/clients/${carrier.client.id}`}>
            ...
            <div className="overflow-hidden rounded-xl border border-gray-100">
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-gray-50">
                  {containers.map((c) => (
                    <tr key={c.id} className="hover:bg-gray-50 cursor-pointer" onClick={() => navigate(`/containers/${c.id}`)}>
                      <td className="p-2">
                        <Link to={`/containers/${c.id}`} className="text-primary-700 hover:underline" onClick={(e) => e.stopPropagation()}>
                          {c.designation}
                        </Link>
                      </td>
