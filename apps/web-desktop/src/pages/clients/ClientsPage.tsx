...
export default function ClientsPage() {
  ...
  const handleImportDone = () => {
    // Force un refetch de la liste apres import (react-query).
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <div className="flex items-center gap-1.5">
              <Link to={`/clients/${row.id}`} className="font-medium text-primary-700 hover:underline" onClick={(e) => e.stopPropagation()}>{row.fullName}</Link>
              {row.employee && (
