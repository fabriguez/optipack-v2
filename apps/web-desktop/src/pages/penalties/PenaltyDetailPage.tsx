          ...
          <AppCard>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                {penalty.parcel ? (
                  <Link to={`/parcels/${penalty.parcel.id}`} className="font-mono text-sm font-medium text-primary-700 hover:underline">
          ...
          <AppCard>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                {penalty.client ? (
                  <Link to={`/clients/${penalty.client.id}`} className="text-sm font-medium text-primary-700 hover:underline">
          ...
          <AppCard>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                {penalty.agency ? (
                  <Link to={`/agencies/${penalty.agency.id}`} className="text-sm font-medium text-primary-700 hover:underline">
                    {penalty.agency.name}
                  </Link>
                ) : (
