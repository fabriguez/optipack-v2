...
/**
 * Chat support Stream reutilisable (page dediee + bulle flottante). Gere la
 * connexion Stream du client et l'ouverture de son channel support unique.
 * Une seule instance StreamChat partagee par apiKey (getInstance) -> pas de
 * double connexion entre la page et le FAB.
 */
export function SupportChat() {
  ...
  useEffect(() => {
    ...
    return () => {
      active = false;
      // Pas de disconnectUser ici : l'instance est partagee (page + FAB).
      // La connexion se ferme a la fermeture de l'onglet.
    };
  }, []);
