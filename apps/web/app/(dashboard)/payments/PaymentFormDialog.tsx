  ...
  return (
    ...
    >
      <form id="payment-form" onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        {/* Agence encaisseuse : uniquement VOS agences (searchers.myAgencies).
            Le backend impute l'encaissement a l'agence de la facture et rejette
            si ce n'est pas une des votres -> impossible d'encaisser pour une
            autre agence. */}
        <Controller
          name="agencyId"
          control={control}
