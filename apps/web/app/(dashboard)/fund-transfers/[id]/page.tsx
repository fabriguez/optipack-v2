...
export default function FundTransferDetailPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params);
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                {transfer.sourceAgency ? (
                  <Link href={`/agencies/${transfer.sourceAgency.id}`} className="text-lg font-bold text-primary-700 hover:underline">
            ...
            <div className="flex items-center gap-3">
              <div>
                ...
                {transfer.destinationAgency ? (
                  <Link href={`/agencies/${transfer.destinationAgency.id}`} className="text-lg font-bold text-primary-700 hover:underline text-right block">
