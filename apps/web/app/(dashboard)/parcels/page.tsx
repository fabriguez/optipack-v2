...
import { parcelCanAct, parcelHandoverAllowed } from '@/lib/permissions/parcelScope';
import { usePermission, useAgencyIds, useIsTenantAdmin } from '@/lib/hooks/usePermission';
...
function ParcelsContent() {
  ...
  const myAgencyIds = useAgencyIds();
    ...
    },
    {
      ...
      render: (row: any) => (
        <RowActions actions={[
          ...
          ...(canDeliverParcel && row.status !== 'DELIVERED' && parcelHandoverAllowed(row, myAgencyIds, isTenantAdmin)
