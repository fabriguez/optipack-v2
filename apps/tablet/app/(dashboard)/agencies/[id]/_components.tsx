...
/** Carte avec en-tete (titre + action) reutilisee par les onglets du detail agence. */
...
/** Petite carte info icone + label + valeur. */
...
/** Carte statistique (label + grande valeur coloree). */
...
/** Etat vide compact pour les onglets. */
